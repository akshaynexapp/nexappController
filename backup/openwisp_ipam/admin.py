...
class IpAddressAdmin(
    ...
    def get_extra_context(self):
        ...
        # return {
        #     'get_next_available_ip_url': reverse_lazy('ipam:get_next_available_ip', args=['0000'])
        # }
    def add_view(self, request, form_url='', extra_context=None):
        extra_context = extra_context or {}
        try:
            extra_context['get_next_available_ip_url'] = reverse('ipam:get_next_available_ip', args=['0000'])
        except NoReverseMatch:
            extra_context['get_next_available_ip_url'] = ''
