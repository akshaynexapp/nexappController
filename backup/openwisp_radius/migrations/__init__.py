...
def add_default_organization(apps, schema_editor):
    ...
    if hasattr(settings, '_OPENWISP_DEFAULT_ORG_UUID'):
        ...
        Organization = get_swapped_model(apps, 'nexapp_users', 'Organization')
...
def add_default_group_to_existing_users(apps, schema_editor):
    Organization = get_swapped_model(apps, 'nexapp_users', 'Organization')
    OrganizationUser = get_swapped_model(apps, 'nexapp_users', 'OrganizationUser')
...
def assign_permissions_to_groups(apps, schema_editor):
    ...
    Group = get_swapped_model(apps, 'nexapp_users', 'Group')
