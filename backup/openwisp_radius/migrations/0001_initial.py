# Generated by Django 4.2.17 on 2025-05-16 07:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nexapp_users.organization', verbose_name='organization')),
            ],
            options={
                'verbose_name': 'group',
                ...
                'abstract': False,
                'swappable': 'NEXAPP_RADIUS_RADIUSGROUP_MODEL',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.CharField(blank=True, choices=[('', 'Unspecified'), ('manual', 'Manually created'), ('email', 'Email'), ('mobile_phone', 'Mobile phone'), ('social_login', 'Social login')], default='', help_text='users can sign up in different ways, some methods are valid as indirect identity verification (eg: mobile phone SIM card in most countries)', max_length=64, verbose_name='registration method')),
            ...
            options={
                ...
                'abstract': False,
                'swappable': 'NEXAPP_RADIUS_REGISTEREDUSER_MODEL',
            },
        ),
        migrations.CreateModel(
            name='RadiusToken',
            ...
            options={
                ...
                'abstract': False,
                'swappable': 'NEXAPP_RADIUS_RADIUSTOKEN_MODEL',
            },
            bases=(openwisp_users.mixins.ValidateOrgMixin, models.Model),
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'radreply',
                'abstract': False,
                'swappable': 'NEXAPP_RADIUS_RADIUSREPLY_MODEL',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('called_station_id', models.CharField(blank=True, db_column='calledstationid', max_length=253, null=True, verbose_name='called station ID')),
                ('calling_station_id', models.CharField(blank=True, db_column='callingstationid', max_length=253, null=True, verbose_name='calling station ID')),
            ...
            options={
                ...
                'abstract': False,
                'swappable': 'NEXAPP_RADIUS_RADIUSPOSTAUTH_MODEL',
            },
            bases=(openwisp_users.mixins.ValidateOrgMixin, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('op', models.CharField(choices=[('=', '='), (':=', ':='), ('+=', '+=')], default='=', max_length=2, verbose_name='operator')),
                ('value', models.CharField(max_length=253, verbose_name='value')),
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.NEXAPP_RADIUS_RADIUSGROUP_MODEL)),
            ],
            options={
                ...
                'abstract': False,
                'swappable': 'NEXAPP_RADIUS_RADIUSGROUPREPLY_MODEL',
            },
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'swappable': 'NEXAPP_RADIUS_RADIUSGROUPCHECK_MODEL',
            },
            bases=(openwisp_radius.base.models.AutoGroupnameMixin, openwisp_radius.base.models.GroupAttributeValidationMixin, models.Model),
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'radcheck',
                'abstract': False,
                'swappable': 'NEXAPP_RADIUS_RADIUSCHECK_MODEL',
            },
            bases=(openwisp_users.mixins.ValidateOrgMixin, openwisp_radius.base.models.AutoUsernameMixin, openwisp_radius.base.models.UserAttributeValidationMixin, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('called_station_id', models.CharField(blank=True, db_column='calledstationid', db_index=True, max_length=253, null=True, verbose_name='called station ID')),
                ('calling_station_id', models.CharField(blank=True, db_column='callingstationid', db_index=True, max_length=253, null=True, verbose_name='calling station ID')),
            ...
            options={
                ...
                'db_table': 'radacct',
                'abstract': False,
                'swappable': 'NEXAPP_RADIUS_RADIUSACCOUNTING_MODEL',
            },
            bases=(openwisp_users.mixins.ValidateOrgMixin, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sms_message', openwisp_utils.fields.FallbackTextField(blank=True, default=None, fallback='{organization} verification code: {code}', help_text='SMS message template used for sending verification code. Must contain "{code}" placeholder for OTP value.', max_length=160, null=True, verbose_name='SMS Message')),
                ('sms_cooldown', openwisp_utils.fields.FallbackPositiveIntegerField(blank=True, default=None, fallback=30, help_text='Time period a user will have to wait before requesting another SMS token (in seconds).', null=True, verbose_name='SMS Cooldown')),
                ...
                ('freeradius_allowed_hosts', openwisp_utils.fields.FallbackTextField(blank=True, default=None, fallback='127.0.0.1', help_text='Comma separated list of IP addresses allowed to access freeradius API', null=True)),
                ('coa_enabled', openwisp_utils.fields.FallbackBooleanChoiceField(blank=True, default=None, fallback=False, help_text='Whether RADIUS Change Of Authoization (CoA) is enabled', null=True, verbose_name='CoA Enabled')),
                ('allowed_mobile_prefixes', openwisp_utils.fields.FallbackTextField(blank=True, default=None, fallback='', help_text='Comma separated list of international mobile prefixes allowed to register via the user registration API.', null=True)),
                ('first_name', openwisp_utils.fields.FallbackCharChoiceField(blank=True, choices=[('disabled', 'Disabled'), ('allowed', 'Allowed'), ('mandatory', 'Mandatory')], default=None, fallback='disabled', help_text='Whether this field should be disabled, allowed or mandatory in the user registration API.', max_length=12, null=True, verbose_name='first name')),
                ('last_name', openwisp_utils.fields.FallbackCharChoiceField(blank=True, choices=[('disabled', 'Disabled'), ('allowed', 'Allowed'), ('mandatory', 'Mandatory')], default=None, fallback='disabled', help_text='Whether this field should be disabled, allowed or mandatory in the user registration API.', max_length=12, null=True, verbose_name='last name')),
                ('location', openwisp_utils.fields.FallbackCharChoiceField(blank=True, choices=[('disabled', 'Disabled'), ('allowed', 'Allowed'), ('mandatory', 'Mandatory')], default=None, fallback='disabled', help_text='Whether this field should be disabled, allowed or mandatory in the user registration API.', max_length=12, null=True, verbose_name='location')),
                ('birth_date', openwisp_utils.fields.FallbackCharChoiceField(blank=True, choices=[('disabled', 'Disabled'), ('allowed', 'Allowed'), ('mandatory', 'Mandatory')], default=None, fallback='disabled', help_text='Whether this field should be disabled, allowed or mandatory in the user registration API.', max_length=12, null=True, verbose_name='birth date')),
                ...
                ('password_reset_url', openwisp_utils.fields.FallbackCharField(blank=True, default=None, fallback='https://{site}/{organization}/password/reset/confirm/{uid}/{token}', help_text='Enter the URL where users can reset their password', max_length=200, null=True, validators=[openwisp_radius.base.validators.password_reset_url_validator], verbose_name='Password reset URL')),
                ('organization', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='radius_settings', to='nexapp_users.organization', verbose_name='organization')),
            ],
            options={
                ...
                'abstract': False,
                'swappable': 'NEXAPP_RADIUS_ORGANIZATIONRADIUSSETTINGS_MODEL',
            },
        ),
        migrations.CreateModel(
            name='Nas',
            ...
            options={
                ...
                'db_table': 'nas',
                'abstract': False,
                'swappable': 'NEXAPP_RADIUS_NAS_MODEL',
            },
            bases=(openwisp_users.mixins.ValidateOrgMixin, models.Model),
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'swappable': 'NEXAPP_RADIUS_RADIUSUSERGROUP_MODEL',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('csvfile', private_storage.fields.PrivateFileField(blank=True, help_text='The csv file containing the user details to be uploaded', null=True, storage=private_storage.storage.files.PrivateFileSystemStorage(base_url='/api/v1/radius/organization/', location='/opt/openwisp2/private'), upload_to=openwisp_radius.base.models._get_csv_file_location, verbose_name='CSV')),
            ...
            options={
                ...
                'db_table': 'radbatch',
                'abstract': False,
                'swappable': 'NEXAPP_RADIUS_RADIUSBATCH_MODEL',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ('-created',),
                'abstract': False,
                'swappable': 'NEXAPP_RADIUS_PHONETOKEN_MODEL',
