...
RadiusToken = swapper.load_model('nexapp_radius', 'RadiusToken')
RegisteredUser = swapper.load_model('nexapp_radius', 'RegisteredUser')
OrganizationRadiusSettings = swapper.load_model(
    'nexapp_radius', 'OrganizationRadiusSettings'
)
User = get_user_model()
