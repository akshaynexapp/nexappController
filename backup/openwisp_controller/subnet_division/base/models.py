...
class AbstractSubnetDivisionRule(TimeStampedEditableModel, OrgMixin):
    ...
    master_subnet = models.ForeignKey(
        swapper.get_model_name('nexapp_ipam', 'Subnet'), on_delete=models.CASCADE
    )
...
class AbstractSubnetDivisionIndex(models.Model):
    ...
    subnet = models.ForeignKey(
        swapper.get_model_name('nexapp_ipam', 'Subnet'),
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    ip = models.ForeignKey(
        swapper.get_model_name('nexapp_ipam', 'IpAddress'),
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
