...
Group = swapper_load_model('nexapp_users', 'Group')
...
class TestAdmin(BaseTestAdmin):
    ...
    def test_notification_setting_inline_organization_formfield(self):
        response = self.client.get(
            reverse('admin:nexapp_users_user_change', args=(self.admin.pk,))
        )
    ...
    def test_org_admin_view_same_org_user_notification_setting(self):
        ...
        response = self.client.get(
            reverse('admin:nexapp_users_user_change', args=(org_admin.user_id,)),
        )
    ...
    def test_ignore_notification_widget_add_view(self):
        url = reverse('admin:nexapp_users_organization_add')
