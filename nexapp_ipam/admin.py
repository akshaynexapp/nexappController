...
class SubnetAdmin(
    ...
    app_label = 'nexapp_ipam'
    change_form_template = 'admin/nexapp-ipam/subnet/change_form.html'
    change_list_template = 'admin/nexapp-ipam/subnet/change_list.html'
    list_display = [
        'name',
        'organization',
        'subnet',
    ...
    def import_view(self, request):
        ...
        form_template = 'admin/nexapp-ipam/subnet/import.html'
    ...
    class Media:
        js = (
            ...
            'nexapp-ipam/js/subnet.js',
            'nexapp-ipam/js/minified/jstree.min.js',
            'nexapp-ipam/js/minified/plotly.min.js',
        )
        css = {
            'all': (
                'nexapp-ipam/css/admin.css',
                'nexapp-ipam/css/minified/jstree.min.css',
            )
        }
...
class IpAddressAdmin(
    ...
    change_form_template = 'admin/nexapp-ipam/ip_address/change_form.html'
